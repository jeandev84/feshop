...
class ProductController extends AppController
{
    ...
    public function indexAction()
    {
        ...
        $products = \R::getAll(
            "SELECT product.*, category.title AS cat 
                 ...
                 ORDER BY product.title LIMIT $start, $perpage");
    ...
    public function addImageAction()
    {
        if(isset($_GET['upload']))
        {
            if($_POST['name'] == 'single'){
                $wmax = App::$app->get('img_width');
                $hmax = App::$app->get('img_height');
            }else{
                $wmax = App::$app->get('gallery_width');
                $hmax = App::$app->get('gallery_height');
            }
            $name = $_POST['name'];
            $product = new Product();
    ...
    public function editAction()
    {
        ...
        $product = \R::load('product', $id);
        App::$app->set('parent_id', $product->category_id);
