     ...
     <div class="col-md-9 single-main-left">
       <div class="sngl-top">
        <div class="col-md-5 single-top-left">
           <!-- Show gallery : if has galleries , we'll show them -->
            <?php if($galleries): ?>
                <div class="flexslider">
                    <ul class="slides">
                        <?php foreach($galleries as $gallery): ?>
                          <li data-thumb="images/<?= $gallery->img ?>">
                            <div class="thumb-image"> <img src="images/<?= $gallery->img ?>" data-imagezoom="true" class="img-responsive" alt=""/> </div>
                        </li>
                        <?php endforeach; ?>
                    </ul>
                </div>
            <?php else: ?> <!-- if has not galleries , we'll show base image -->
...
<?php
$curr = \Framework\App::$app->get('currency');
$categories = \Framework\App::$app->get('categories');
...
<div class="col-md-7 single-top-right">
    <div class="single-para simpleCart_shelfItem">
        ...
        <div class="tabs">
         ...
         <!-- show related product Связанные торава-->
         <?php if($related): ?>
                             ...
                             <div class="product-main simpleCart_shelfItem">
                                 ...
                                 <div class="product-bottom">
                                     ...
                                     <h4>
                                         ...
                                         <!-- show prices [ current price and old price ]-->
         ...
         <?php endif; ?>
         <!-- end show lasts viewed products-->
