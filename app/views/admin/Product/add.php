    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <!-- если форма передается асинхрона тогда нет смысла указать аттрибут multipart/form-data -->
                <form action="<?=ADMIN;?>/product/add" method="post" data-toggle="validator" id="add">
                    <div class="box-body">
                        ...
                        <div class="form-group has-feedback">
                            <label for="price">Цена</label><!-- pattern от нуля до 9 и точка, и больше одного симбола -->
